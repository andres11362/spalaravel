          ...
          <div class="col-md-12">
              <div class="panel panel-default">
                  <div class="panel-heading">
                        <h3><span class="glyphicon glyphicon-menu-hamburger"></span> Assignment Dashboard </h3> <br>
                        <button @click="initAddTask()" class="btn btn-success " style="padding:5px">
                            Add New Assignment
                        </button>
                  </div>
                  <div class="panel-body">
                        <table class="table table-striped table-bordered table-responsive" v-if="tasks.length > 0">
                            <tbody>
                                <tr>
                                    <th>
                                        N°
...
export default {
    ...
    methods: 
    {
        deleteTask(index){
            ...
            if(conf == true){
                axios.delete('http://localhost/spalaravel/public/task/'+this.tasks[index].id)
                     .then(
                        response => {
        ...
        createTask()
        {
            axios.post('http://localhost/spalaravel/public/task', {
                name:           this.task.name,
        ...
        readTask()
        {
            axios.get('http://localhost/spalaravel/public/task')
                 .then(
                    response =>{
        ...
        updateTask()
        {
            axios.patch('http://localhost/spalaravel/public/task/' + this.update_task.id, {
